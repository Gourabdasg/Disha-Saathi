...
class FirebaseAuthService {
  ...
  // --- 1. Email OTP / Verification Authentication ---

  static Future<bool> sendEmailOtp(String email) async {
    try {
      final actionCodeSettings = ActionCodeSettings(
        url: 'https://disha-saathi.firebaseapp.com/finishSignUp?email=$email',
        handleCodeInApp: true,
        androidPackageName: 'com.aialchemists.disha_saathi',
      ...
      return true; // Fast fallback so flow continues
    }
  }
  ...
  static Future<void> sendPhoneOtp({
    ...
    try {
      ...
      onError('Unable to send OTP. Please check your internet connection.');
    }
  }
